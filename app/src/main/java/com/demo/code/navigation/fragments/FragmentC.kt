...
import com.demo.extensions.toast.toast

class FragmentC : Fragment() {

    private var _binding: FragmentLayoutCBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentLayoutCBinding.inflate(inflater, container, false)
        return binding.root
    }
